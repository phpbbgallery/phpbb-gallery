...
function get_schema_struct()
{
	...
	$schema_data['phpbb_album'] = array(
		'COLUMNS'		=> array(
			'pic_id'			=> array('UINT', NULL, 'auto_increment'),
			'pic_filename'		=> array('VCHAR:255', ''),
			'pic_thumbnail'		=> array('VCHAR:255', ''),
			'pic_title'			=> array('VCHAR:255', ''),
			'pic_desc'					=> array('MTEXT_UNI', ''),
			'pic_desc_bbcode_uid'		=> array('VCHAR:8', ''),
			'pic_desc_bbcode_bitfield'	=> array('VCHAR:255', ''),
			'pic_user_id'		=> array('UINT', 0),
			'pic_username'		=> array('VCHAR:32', ''),
			'pic_user_ip'		=> array('VCHAR:40', ''),
			'pic_time'			=> array('UINT:11', 0),
			'pic_cat_id'		=> array('UINT', 0),
			'pic_view_count'	=> array('UINT:11', 0),
			'pic_lock'			=> array('BOOL', 0),
	...
	$schema_data['phpbb_album_cat'] = array(
		'COLUMNS'		=> array(
			...
			'cat_desc_bbcode_uid'		=> array('VCHAR:8', ''),
			'cat_desc_bbcode_bitfield'	=> array('VCHAR:255', ''),
			'cat_order'			=> array('UINT', 0),
			'cat_view_level'	=> array('BOOL', 1),
			'cat_upload_level'	=> array('BOOL', 0),
			'cat_rate_level'	=> array('BOOL', 0),
			'cat_comment_level'	=> array('BOOL', 0),
			'cat_edit_level'	=> array('BOOL', 0),
			'cat_delete_level'	=> array('BOOL', 2),
			'cat_view_groups'		=> array('VCHAR:255', ''),
			'cat_upload_groups'		=> array('VCHAR:255', ''),
			'cat_rate_groups'		=> array('VCHAR:255', ''),
			'cat_comment_groups'	=> array('VCHAR:255', ''),
			'cat_edit_groups'		=> array('VCHAR:255', ''),
			'cat_delete_groups'		=> array('VCHAR:255', ''),
			'cat_moderator_groups'	=> array('VCHAR:255', ''),
	...
	$schema_data['phpbb_album_comment'] = array(
		'COLUMNS'		=> array(
			...
			'comment_pic_id'		=> array('UINT', NULL),
			...
			'comment_text_bbcode_uid'		=> array('VCHAR:8', ''),
			'comment_text_bbcode_bitfield'	=> array('VCHAR:255', ''),
	...
	$schema_data['phpbb_album_rate'] = array(
		'COLUMNS'		=> array(
			'rate_pic_id'		=> array('UINT', NULL, 'auto_increment'),

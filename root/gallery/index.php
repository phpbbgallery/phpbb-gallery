...
$template->assign_vars(array(
	...
	'U_USERS_PERSONAL_GALLERIES' 	=> (gallery_acl_check('i_view', PERSONAL_GALLERY_PERMISSIONS)) ? append_sid("{$phpbb_root_path}{$gallery_root_path}index.$phpEx", 'mode=personal') : '',
